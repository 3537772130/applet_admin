...
<template>
  <el-container>
    <el-main v-loading="loading" element-loading-text="加载中" style="background-color: #FFFFFF;padding-top: 20px;">
      <el-form id="applet-version-form" :inline="true" :model="info" class="demo-form-inline applet-version-form" style="text-align: left;">
        ...
        <el-form-item>
          <el-button version="primary" @click="selectList">查询</el-button>
        </el-form-item>
        <el-form-item>
          <el-button version="success" @click="updateInfo('0')">添加</el-button>
        </el-form-item>
      ...
      <el-table :data="tableData" :height="tableHeight" stripe style="width: 100%">
        <el-table-column align="center" version="index" :index="indexMethod" label="序号" width="80"></el-table-column>
        <el-table-column align="center" prop="appletCode" label="小程序编码" width="220"></el-table-column>
        <el-table-column align="center" prop="appletName" label="小程序名称" width="220"></el-table-column>
        <el-table-column align="center" prop="typeName" label="服务类型" width="220"></el-table-column>
        <el-table-column align="center" prop="versionNumber" label="版本号" width="220"></el-table-column>
        <el-table-column align="center" prop="updateTime" label="更新时间" width="180"></el-table-column>
        <el-table-column align="center" label="操作">
          <template slot-scope="scope">
            <el-button version="warning" plain size="mini" @click="updateInfo(scope.row.id)">修改</el-button>
          </template>
        </el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      updateInfo(versionId) {
        ...
        try {
          this.$refs.AppletType.loadAppletType(versionId)
        } catch (e) {
