    ...
    <el-main v-loading="loading" element-loading-text="加载中" style="background-color: #FFFFFF;">
      <el-form :rules="elementRules" :inline="true" :model="elementForm" ref="elementForm" class="demo-form-inline">
        ...
        <el-form-item label="元素类型" prop="typeId">
          <el-select v-model="elementForm.typeId" placeholder="请选择元素类型" class="part-input">
        ...
        <!--                    resize="none" rows="5" placeholder="请输入默认内容(json格式)" class="part-input"></el-input>-->
        <!--        </el-form-item>-->
        <el-form-item label="元素状态" prop="elementStatus">
          <el-select v-model="elementForm.elementStatus" placeholder="请选择元素状态" class="part-input">
        ...
        <br>
        <el-form-item label=" ">
          <el-button type="primary" @click="onSubmit()" class="part-input">提交</el-button>
        </el-form-item>
      </el-form>
    </el-main>
  </div>
